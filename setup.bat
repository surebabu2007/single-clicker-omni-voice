...
title OmniVoice - Setup & Installation

:: =============================================
:: OmniVoice First-Time Setup
:: by sureshpydikondala
:: https://huggingface.co/k2-fsa/OmniVoice
::
:: Run this ONCE to install everything.
:: After setup, use run.bat to launch OmniVoice.
:: =============================================
...
:: =============================================
:: SECTION 2: Sentinel Check (Already Installed)
:: =============================================
if exist "%SENTINEL%" (
    echo.
    echo  [INFO] OmniVoice is already installed.
    echo         Run run.bat to launch OmniVoice.
    echo.
    echo         To force reinstallation, delete:
    echo           %SENTINEL%
...
if errorlevel 1 (
    ...
    echo.
    echo  Re-run setup.bat to resume - downloads are resumable.
